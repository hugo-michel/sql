...
FROM `student` 
WHERE email LIKE '%.fr%'
OR created_at <= '2021-01-10 23:59:59';
...
FROM `student` 
WHERE email LIKE '%.fr%'
AND created_at <= '2021-01-10 23:59:59';
...
OR start_date >= '2021-07-01 00:00:00';
...
FROM `project`
WHERE description NOT LIKE '%Dolores%'
AND start_date >= '2021-07-01 00:00:00';
...
SELECT * FROM `project`
WHERE start_date >= '2021-01-01 00:00:00'
AND start_date < '2021-07-02 00:00:00';
...
SELECT * 
FROM `student` 
WHERE (email LIKE '%.fr%' AND created_at <= '2021-01-10 23:59:59')
